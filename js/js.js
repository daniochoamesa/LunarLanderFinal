	...
	document.getElementById("dificultad").onclick = function cambiarDificultad(){
		switch(dificultad){
			case 1:
				gasolina=50;
				gasolinaTotal=50;
				document.getElementById("dificultad").innerHTML="Díficil";
				dificultad=2
				restart();
				break;
			case 2:
...
function moverNave(){
	...
	//mover hasta que top sea un 74% de la pantalla
	if (y<74){ 
...
//FUNCION PARA ACABAR EL JUEGO PRUEBA
function finalizarJuego() {
	if (v>5) {
		switch (modeloNave) {
			case 1:
			eventosOff();
			document.getElementById("imgNave").src="img/destruccion.gif";
